...
@section('content')
    <div class="wrapper admin">
        ...
        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-10 content">
            <div class="title">
                <h2>
                    Sell Tickets : {{$screening->movie->name}} {{$screening->movie->details->release_year}} -
                    {{\Carbon\Carbon::parse($screening->show_time)->toDayDateTimeString()}}
                </h2>

                <a href="/admin/screenings/{{$screening->id}}/reservations" class="btn btn-default">
                    <span>
                        Back
                    </span>
                </a>
            ...
            <div>
                <form class="col-sm-12 col-md-6 col-lg-6" method="post" action="/admin/screenings/{{$screening->id}}/reservations" style="padding: 0px;" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group {{ $errors->has('tickets') ? ' has-error' : '' }}">
                        ...
                        <div class="">
                            <input id="tickets_count" type="text" name="tickets" value="{{ old('tickets') }}">
