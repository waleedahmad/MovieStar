...
@section('content')
    <div class="wrapper admin">
        ...
        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-10 content">
            ...
            <div>
                <form class="col-sm-12 col-md-6 col-lg-6" method="post" action="/admin/movies/update" style="padding: 0px;" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
                        ...
                        <div class="">
                            <input id="name" type="text" name="name" value="{{ old('name') ? old('name') : $movie->name }}" autofocus>
                    ...
                    <div class="form-group {{ $errors->has('year') ? ' has-error' : '' }}">
                        ...
                        <div class="">
                            <input id="year" type="text" name="year" value="{{ old('year') ? old('year') : $movie->details->release_year }}">
                    ...
                    <div class="form-group {{ $errors->has('director') ? ' has-error' : '' }}">
                        ...
                        <div class="">
                            <input id="director" type="text" name="director" value="{{ old('director') ? old('director') : $movie->details->director }}">
                    ...
                    <div class="form-group {{ $errors->has('youtube_url') ? ' has-error' : '' }}">
                        ...
                        <div class="">
                            <input id="youtube_url" type="text" name="youtube_url" value="{{ old('youtube_url') ? old('youtube_url') : $movie->details->youtube_url }}">
                    ...
                    <div class="form-group {{ $errors->has('audience') ? ' has-error' : '' }}">
                        ...
                        <div class="">
                            <select name="audience" id="audience">
                                <option value="" {{old('audience') ? old('audience') : $movie->details->audience === '' ? 'selected' : ''}}>Select</option>
                                <option value="G" {{old('audience') ? old('audience') : $movie->details->audience === 'G'  ? 'selected' : ''}}>G - General Audiences</option>
                                <option value="PG" {{old('audience') ? old('audience') : $movie->details->audience === 'PG' ? 'selected' : ''}}>PG – Parental Guidance Suggested</option>
                                <option value="PG-13" {{old('audience') ? old('audience') : $movie->details->audience === 'PG-13' ? 'selected' : ''}}>PG-13 – Parents Strongly Cautioned</option>
                                <option value="R" {{old('audience') ? old('audience') : $movie->details->audience === 'R' ? 'selected' : ''}}>R – Restricted</option>
                                <option value="NC-17" {{old('audience') ? old('audience') : $movie->details->audience === 'NC-17' ? 'selected' : ''}}>NC-17 – Adults Only</option>
                    ...
                    <div class="form-group {{ $errors->has('description') ? ' has-error' : '' }}">
                        ...
                        <div class="">
                            <input id="description" type="text" name="description" value="{{ old('description') ? old('description') : $movie->details->description }}">
                    ...
                    <div class="form-group {{ $errors->has('plot') ? ' has-error' : '' }}">
                        ...
                        <div class="">
                            <textarea id="plot" name="plot">{{ old('plot') ? old('plot') : $movie->details->plot }}</textarea>
                    ...
                    <div class="form-group {{ $errors->has('facebook') ? ' has-error' : '' }}">
                        ...
                        <div class="">
                            <input id="facebook" type="text" name="facebook" value="{{ old('facebook') ? old('facebook') : $movie->details->facebook }}">
                    ...
                    <div class="form-group {{ $errors->has('twitter') ? ' has-error' : '' }}">
                        ...
                        <div class="">
                            <input id="twitter" type="text" name="twitter" value="{{ old('twitter') ? old('twitter') : $movie->details->twitter }}">
                    ...
                    <div class="form-group {{ $errors->has('starring') ? ' has-error' : '' }}">
                        ...
                        <div class="">
                            <input id="starring" type="text" name="starring" value="{{ old('starring') ? old('starring') : $movie->details->starring}}">
                    ...
                    <div class="form-group {{ $errors->has('running_time') ? ' has-error' : '' }}">
                        ...
                        <div class="">
                            <input id="running_time" type="text" name="running_time" value="{{ old('running_time') ? old('running_time') : $movie->details->running_time}}">
                                ...
                                <div class="col-xs-6">
                                    <input type="checkbox"
                                           ...
                                           name="genre[]" value="{{$genre->id}}"
                                            {{old('genre') ?  in_array($genre->id, old('genre')) ? 'checked' : '' : in_array($genre->id, $movie->genre->pluck('genre_id')->toArray()) ? 'checked' : ''}}>
                                    {{$genre->name}}
                                </div>
                            @endforeach
                        </div>
